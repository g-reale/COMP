...
const array<string,(size_t)token_t::_COUNT> Lexer::TOKEN_RULES = []{
    ...
    rules[(size_t)token_t::IDENTIFIER]   = R"([a-zA-Z_]+)";
    rules[(size_t)token_t::ASCII]        = R"('(?:\\[ntr0'"]|[\x00-\x7F])')";
    return rules;
}();

const array<size_t,(size_t)token_t::_COUNT> Lexer::RULE_PRIORITY = {
    (size_t)token_t::COMMENT,
    (size_t)token_t::ASCII,
    (size_t)token_t::LESS_EQ,
    (size_t)token_t::MORE_EQ,
    (size_t)token_t::LOGICAL_EQ,
    (size_t)token_t::NOT_EQUAL,
    (size_t)token_t::SUM,
    (size_t)token_t::SUB,
    (size_t)token_t::DIV,
    (size_t)token_t::MUL,
    ...
    (size_t)token_t::MORE,
    (size_t)token_t::SEMI,
    (size_t)token_t::COMMA,
    (size_t)token_t::EQUAL,
    (size_t)token_t::OPEN_ROUND,
    (size_t)token_t::CLOSE_ROUND,
    (size_t)token_t::OPEN_SQUARE,
    (size_t)token_t::CLOSE_SQUARE,
    (size_t)token_t::OPEN_CURLY,
    (size_t)token_t::CLOSE_CURLY,
    (size_t)token_t::NUM,
    (size_t)token_t::LINE_END,
    (size_t)token_t::IF,
    (size_t)token_t::INT,
    (size_t)token_t::VOID,
    (size_t)token_t::ELSE,
    (size_t)token_t::WHILE,
    (size_t)token_t::RETURN,
    (size_t)token_t::IDENTIFIER,
};

const regex Lexer::TOKEN_FINDER = []{
    std::string rules = "";
    for(size_t i = 0; i < (size_t)token_t::_COUNT; i++)
        rules += "(" + TOKEN_RULES[RULE_PRIORITY[i]] + ")|";
    rules.pop_back();
    return regex(rules);
}();
...
parseble_t Lexer::tokenize(bool& finished){
    ...
    for(size_t i = 1; i < matches.size(); i++){
        ...
        at = matches[0].second;
        token = (token_t)RULE_PRIORITY[i-1];
