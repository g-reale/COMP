...
GRAMMAR = {
    ...
    "SCALAR_DECL":           {("SEMI",)},
    "VOID_FUN_DECL":         {("OPEN_ROUND", "PARAMS", "CLOSE_ROUND", "VOID_COMPOSED_DECL")},
    "INT_FUN_DECL":          {("OPEN_ROUND", "PARAMS", "CLOSE_ROUND", "INT_COMPOSED_DECL")},
    ...
    "INT_SELECTION_DECL":    {("IF", "OPEN_ROUND", "EXPRESSION", "CLOSE_ROUND", "INT_STATEMENT", "OPTIONAL", "ELSE", "INT_STATEMENT", "OPTIONAL")},
    "INT_ITERATION_DECL":    {("WHILE", "OPEN_ROUND", "EXPRESSION", "CLOSE_ROUND", "INT_STATEMENT")},
    ...
    "VOID_SELECTION_DECL":   {("IF", "OPEN_ROUND", "EXPRESSION", "CLOSE_ROUND", "VOID_STATEMENT", "OPTIONAL", "ELSE", "VOID_STATEMENT", "OPTIONAL")},
    "VOID_ITERATION_DECL":   {("WHILE", "OPEN_ROUND", "EXPRESSION", "CLOSE_ROUND", "VOID_STATEMENT")},
